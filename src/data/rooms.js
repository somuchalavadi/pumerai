...
export const rooms = [
  {
    ...
    coverImage: "/rooms/club-room-with-balcony/cover.jpg",
    fallbackImage: editorialFrames.roomTwo, // frame 206
    galleryPhotos: [
      "/rooms/club-room-with-balcony/cover.jpg",
      "/rooms/club-room-with-balcony/1.jpg",
      "/rooms/club-room-with-balcony/2.jpg",
      "/rooms/club-room-with-balcony/3.jpg",
    ],
    fallbackGallery: [
      framePath(206),
      framePath(208),
  ...
  },
  {
    ...
    coverImage: "/rooms/club-room/cover.jpg",
    fallbackImage: editorialFrames.roomThree, // frame 218
    galleryPhotos: [
      "/rooms/club-room/cover.jpg",
      "/rooms/club-room/1.jpg",
      "/rooms/club-room/2.jpg",
      "/rooms/club-room/3.jpg",
    ],
    fallbackGallery: [
      framePath(218),
      framePath(220),
  ...
  },
  {
    ...
    coverImage: "/rooms/deluxe-room/cover.jpg",
    fallbackImage: editorialFrames.roomOne, // frame 198
    galleryPhotos: [
      "/rooms/deluxe-room/cover.jpg",
  ...
  },
  {
    ...
    coverImage: "/rooms/family-suite-room/cover.jpg",
    fallbackImage: framePath(220),
    galleryPhotos: [
      "/rooms/family-suite-room/cover.jpg",
      "/rooms/family-suite-room/1.jpg",
      "/rooms/family-suite-room/2.jpg",
      "/rooms/family-suite-room/3.jpg",
    ],
    fallbackGallery: [
      framePath(220),
      framePath(218),
  ...
  },
  {
    ...
    coverImage: "/rooms/premium-room/cover.jpg",
    fallbackImage: framePath(194),
    galleryPhotos: [
      "/rooms/premium-room/cover.jpg",
      "/rooms/premium-room/1.jpg",
      "/rooms/premium-room/2.jpg",
      "/rooms/premium-room/3.jpg",
    ],
    fallbackGallery: [
      framePath(194),
      framePath(198),
  ...
  },
  {
    ...
    coverImage: "/rooms/premium-twin-room/cover.jpg",
    fallbackImage: framePath(204),
    galleryPhotos: [
      "/rooms/premium-twin-room/cover.jpg",
      "/rooms/premium-twin-room/1.jpg",
      "/rooms/premium-twin-room/2.jpg",
      "/rooms/premium-twin-room/3.jpg",
    ],
    fallbackGallery: [
      framePath(204),
      framePath(198),
  ...
  },
  {
    ...
    coverImage: "/rooms/suite-room/cover.jpg",
    fallbackImage: editorialFrames.roomFour, // frame 232
    galleryPhotos: [
      "/rooms/suite-room/cover.jpg",
      "/rooms/suite-room/1.jpg",
      "/rooms/suite-room/2.jpg",
      "/rooms/suite-room/3.jpg",
    ],
    fallbackGallery: [
      framePath(232),
      framePath(228),
